...
#ifndef ARCHON_UTILITIES_IMAGE_PNM_HPP
#define ARCHON_UTILITIES_IMAGE_PNM_HPP
...
namespace archon
{
  namespace utilities
  {
     ...
     *
     * \return 0 if there is no support for PNM, otherwise a pointer
     * to the default PNM format. The ownership of the referenced
...
#endif // ARCHON_UTILITIES_IMAGE_PNM_HPP
