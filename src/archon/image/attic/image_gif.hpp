...
#ifndef ARCHON_UTILITIES_IMAGE_GIF_HPP
#define ARCHON_UTILITIES_IMAGE_GIF_HPP
...
namespace Archon
{
  namespace Utilities
  {
     ...
     *
     * \return 0 if there is no support for GIF, otherwise a pointer
     * to the default GIF format. The ownership of the referenced
...
#endif // ARCHON_UTILITIES_IMAGE_GIF_HPP
