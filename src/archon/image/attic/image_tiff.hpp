...
#ifndef ARCHON_UTILITIES_IMAGE_TIFF_HPP
#define ARCHON_UTILITIES_IMAGE_TIFF_HPP
...
namespace Archon
{
  namespace Utilities
  {
     ...
     *
     * \return 0 if there is no support for TIFF, otherwise a pointer
     * to the default TIFF format. The ownership of the referenced
...
#endif // ARCHON_UTILITIES_IMAGE_TIFF_HPP
