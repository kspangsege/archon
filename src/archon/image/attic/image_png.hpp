...
#ifndef ARCHON_UTILITIES_IMAGE_PNG_HPP
#define ARCHON_UTILITIES_IMAGE_PNG_HPP
...
namespace Archon
{
  namespace Utilities
  {
     ...
     *
     * \return 0 if there is no support for PNG, otherwise a pointer
     * to the default PNG format. The ownership of the referenced
...
#endif // ARCHON_UTILITIES_IMAGE_PNG_HPP
