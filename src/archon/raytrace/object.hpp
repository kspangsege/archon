...
public:
    ...
    static std::unique_ptr<Object> make_box(std::shared_ptr<Material>);
    ...
    static std::unique_ptr<Object> make_cone(std::shared_ptr<Material>);
    ...
    /// respectively.
    static std::unique_ptr<Object> make_cylinder(std::shared_ptr<Material>);
    ...
    static std::unique_ptr<Object> make_sphere(std::shared_ptr<Material>);
    ...
    static std::unique_ptr<Object> make_torus(std::shared_ptr<Material>,
