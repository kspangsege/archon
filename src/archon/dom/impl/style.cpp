...
namespace archon
{
  namespace DomImpl
  {
    void StaticStyleInfo::add_props()
    {
      ...
      add("border-top",    new BorderTopPropDef);
      add("border-right",  new BorderRightPropDef);
      add("border-bottom", new BorderBottomPropDef);
      add("border-left",   new BorderLeftPropDef);
      ...
      add("padding", new PaddingPropDef);
      add(&SizeGroup::width);
