...
//    std::locale::global(std::locale(""));
    ...
    test_config.inner_log_level_limit = base::LogLevel::info;                                  
    ...
    std::string_view filter = "CharCodec_CodecvtBaseline"; // "Base_TextFile_AsciiCodecError_CHECK"; //   "Base_PrimTextFileImpl_* Base_PrimTextFile_* Base_TextFileImpl_* Base_TextFile_*";            
    bool xml = false;
