...
#include <archon/parser/nfa_print.hpp>
#include <archon/parser/nfa_ops.hpp>
...
int main() throw()
{
  WideRegex::Exp e = WideRegex::alt(WideRegex::jux(WideRegex::alt(WideRegex::rep(WideRegex::alt(WideRegex::plus(WideRegex::str(L"Kim Possible")),
                                    ...
                                    WideRegex::range(WideRegex::CharRange(L'a', L'z'), true));

  WideNfa::Ref a = WideNfaFromRegex::construct(e);

  WideRegexPrinter p;
  WideNfaPrinter q;

  cout << envEncode(p.print(e)) << endl;
  cout << envEncode(q.print(a)) << endl;
